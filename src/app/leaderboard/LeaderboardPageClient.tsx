  ...
  async function loadSeasonLeaderboard(currentUserId: string | null) {
    ...
    while (true) {
      const { data: batch } = await supabase
        ...
        .range(profileOffset, profileOffset + PAGE - 1);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mt-12 max-w-4xl mx-auto">
          <h2 className="text-xl font-bold mb-3 text-text">How the Leaderboard Works</h2>
          <div className="text-textMuted text-sm leading-relaxed space-y-3">
            <p>
              The Play Predict Win leaderboard tracks every player&apos;s performance across the Premier League 2026/27 season. You can view standings in three modes: weekly (for the current gameweek), monthly (for each calendar month of the season), and season-long (cumulative totals across all 38 gameweeks). Use the toggle above the table to switch between modes.
            </p>
            <p>
              Points are calculated as follows: 3 points for every exact scoreline predicted correctly (e.g. you predicted 2-1 and the match ended 2-1), 1 point for predicting the correct result but wrong score (e.g. you said 2-1, it ended 3-1), and 0 points for incorrect predictions. The Double Up bonus doubles your points on one match per gameweek — if that match scores you 6 points instead of 3, it can make a significant difference to your position.
            </p>
            <p>
              Tiebreakers are applied in this order: most exact scorelines, then most correct results, then earliest username alphabetically. The leaderboard updates automatically as match results are confirmed. Your current position is highlighted in the table, and if you are in the top three, you will see a medal emoji next to your rank.
            </p>
            <p>
              Predictions lock when the first match of each gameweek kicks off. You can still view the leaderboard and other players&apos; results at any time, but you cannot change predictions for matches that have already started. Check back after each matchday to see how your predictions performed.
            </p>
          </div>
        </section>
      </main>
