    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mt-12 max-w-3xl mx-auto">
          <h2 className="text-xl font-bold mb-3 text-text">How the Prize System Works</h2>
          <div className="text-textMuted text-sm leading-relaxed space-y-3">
            <p>
              Play Predict Win is completely free to enter — there are no entry fees, subscriptions, or hidden costs. Every penny of the prize fund goes directly to the winners, paid by bank transfer or PayPal within 30 days of the season finale.
            </p>
            <p>
              The weekly £50 prize goes to the player with the most points across all Premier League matches in that gameweek. The monthly £100 pot is split between the top three predictors on the monthly leaderboard — first place takes £100, second gets £50, and third receives £25. At the end of the season, the overall champion earns £500.
            </p>
            <p>
              Points are awarded as follows: 3 points for every exact scoreline predicted correctly, and 1 point for predicting the correct result (win, draw, or loss) with the wrong score. Wrong predictions earn nothing. The Double Up bonus gives you the chance to double your points on one match per gameweek — use it wisely on your most confident prediction.
            </p>
            <p>
              All prizes are paid directly to the winners&apos; bank accounts or PayPal. You must have a verified account and a UK or EU bank account (or PayPal linked to one) to claim. Prizes expire if unclaimed after 30 days.
            </p>
          </div>
        </section>
      </main>
