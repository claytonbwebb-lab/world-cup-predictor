...
const partners = [
  ...
  {
    name: 'Inked Memorabilia',
    logo: '/images/partners/inkedmemorabilia.png',
    url: '/inkedmemorabilia',
    alt: 'Inked Memorabilia',
    tagline: 'Authentic, hand-signed sports memorabilia',
    description: 'Inked Memorabilia offers authentic, hand-signed sports memorabilia, with every item supplied with a Certificate of Authenticity. Pieces are signed during private sessions and include photographic proof, giving collectors confidence in every purchase.',
    stats: `We don't just tell you it's authentic...we show you!`,
    bgImage: '/images/partners/allstar-signings-partner-bg.jpg',
    bgAlt: 'Inked Memorabilia — signed football shirts and memorabilia display',
    bgPosition: 'top center',
  },
  {
    name: 'Butterworth Menswear',
    logo: '/images/partners/butterworths.png',
    url: '/butterworths',
    alt: 'Butterworth Menswear',
    tagline: `Online menswear fashion brands`,
    description: "Butterworth Menswear is a menswear destination for iconic fashion brands that have long been embraced by the casuals scene. Built around timeless style, quality and everyday wearability, it brings together classic labels that appeal to shoppers who value heritage, authenticity and standout design.",
    stats: `Everyday menswear that speaks confidence.`,
    bgImage: '/images/partners/butterworths-partner-bg.jpg',
    bgAlt: 'Butterworth Menswear — football themed artwork and prints',
  },
  {
