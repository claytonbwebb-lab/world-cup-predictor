    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/95 backdrop-blur">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <Image src="/images/logos/logo3.jpg" alt="Play Predict Win" width={120} height={40}
            className="object-contain" style={{ maxHeight: '36px' }} />
        </Link>
        ...
        <div className="flex items-center gap-3 text-sm shrink-0">
          <Link href="/auth/login"
            className="text-textMuted hover:text-text transition-colors font-medium">
            Sign In
          </Link>
          <Link href="/auth/signup"
            className="btn-primary text-sm px-4 py-2 rounded-lg font-bold">
            Join the League
          </Link>
        </div>
