    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/95 backdrop-blur">
      <div className="max-w-6xl mx-auto px-4 py-3">
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2">
          ...
          {/* LEFT — social icons (desktop) / empty spacer (mobile) */}
          <div className="flex items-center gap-3">
            <a href="https://x.com/playpredictwin" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hidden sm:flex text-textMuted hover:text-white transition-colors">
            ...
            <a href="https://instagram.com/playpredictwin" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hidden sm:flex text-textMuted hover:text-[#E4405F] transition-colors">
            ...
            <a href="https://tiktok.com/@playpredictwin" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hidden sm:flex text-textMuted hover:text-white transition-colors">
